...
public class LeadDisplay2 extends PApplet{
    ...
    public LeadDisplay2(ClientStat cs, int r, communication u,EcgRecordGraph er,EcgDisplay ed,JabberSmackAPI j) {
        clstat = cs;
        resolution = r;
        usb = u;
        ecgr = er;
      ...
      int del3Y[] = new int[512];
       ...
       else if(clstat.getSendDataFlag() == 2)
       {
          int j = 0;
            ...
            ecgD.jTabbedPane1.setSelectedIndex(1);
        }
        

        if(clstat.getLeadNo().equals("Lead aVR"))
        ...
        if(isLocal1 && bf1)
       {
           ...
           for (int i = 0; i < del3Y.length; i++)
           {
               int xto = (int) (i * del);
                ...
                //line(localXprev,((offset* 1.0f)-localYprev)+(100), xto,((offset* 1.0f)-yto)+(100));
       ...
       if(isLocal2 && bf2)
       {
           ...
           for (int i = 0; i < del3Y.length; i++)
           {
               int xto = (int) (i * del);
                ...
                //line(localXprev,((offset* 1.0f)-localYprev)+(175), xto,((offset* 1.0f)-yto)+(175));
        ...
        if(isLocal3 && bf3)
       {
           ...
           for (int i = 0; i < del3Y.length; i++)
           {
               int xto = (int) (i * del);
                ...
                //line(localXprev,((offset* 1.0f)-localYprev)+(300), xto,((offset* 1.0f)-yto)+(300));
...
//                yto = height-yto;
                ...
                //line(xprev,((offset* 1.0f)-yprev)+(midpoint), xto,((offset* 1.0f)-yto)+(midpoint));
